...
void setup() {
  ...
  Serial.print((flags & RV8803_FLAG_UPDATE) ? 1 : 0);
  Serial.print(F(" Timer="));
  Serial.print((flags & RV8803_FLAG_TIMER) ? 1 : 0);
  Serial.print(F(" Alarm="));
  Serial.print((flags & RV8803_FLAG_ALARM) ? 1 : 0);
  Serial.print(F(" Event="));
  Serial.print((flags & RV8803_FLAG_EVENT) ? 1 : 0);
  Serial.print(F(" Time invalid="));
  Serial.print((flags & RV8803_FLAG_TIME_INVALID) ? 1 : 0);
  Serial.print(F(" Temperature compensation interrupted="));
  Serial.println((flags & RV8803_FLAG_TEMP_COMP_STOPPED) ? 1 : 0);
